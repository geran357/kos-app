...
const useWebhooks = require("./useWebhooks-z_AFCi-T.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-SV7Fa82F.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-m79-NRwG.js.map
