...
const index$1 = require("./index-mcvvczRH.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-UFM6gtCv.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-UFM6gtCv.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-9WCDZoNG.js.map
