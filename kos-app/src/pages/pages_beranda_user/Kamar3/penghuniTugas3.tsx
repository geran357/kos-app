...
const ChecklistTasks3: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        // Memfilter berdasarkan documentId 'lag37nj0ddsmpbw598mijhfl'
        const response = await fetch(
          "http://localhost:1337/api/tasks?filters[documentId][$eq]=lag37nj0ddsmpbw598mijhfl&populate=*"
        );
...
export default ChecklistTasks3;
