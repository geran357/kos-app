...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-ySKe4ceU.js"));
        return component;
      }
    });
    app.registerPlugin({
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-ThDPfx3K.js"));
        return component;
      },
      permissions: PERMISSIONS.main
    });
...
//# sourceMappingURL=index-9ak7YNLG.js.map
