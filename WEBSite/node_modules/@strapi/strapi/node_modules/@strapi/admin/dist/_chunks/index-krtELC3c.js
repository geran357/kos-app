...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await Promise.resolve().then(() => require("./Login-yw3gBaX0.js"))).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await Promise.resolve().then(() => require("./constants-z9e82QJ6.js"))).FORMS,
    {
...
const AuthenticatedApp = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./AuthenticatedApp-SrTNvEIb.js")).then((n) => n.AuthenticatedApp).then((mod) => ({ default: mod.AuthenticatedApp }))
);
const App$2 = ({ authLogo, menuLogo, showReleaseNotification, showTutorials }) => {
  const adminPermissions = useEnterprise(
    ADMIN_PERMISSIONS_CE,
    async () => (await Promise.resolve().then(() => require("./constants-WeTXow7d.js"))).ADMIN_PERMISSIONS_EE,
    {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await Promise.resolve().then(() => require("./constants-WeTXow7d.js"))).ROUTES_EE,
    {
      defaultValue: []
    }
  );
...
const EditViewPage = ({
  ...
  const Information2 = useEnterprise(
    InformationBoxCE,
    async () => (await Promise.resolve().then(() => require("./InformationBoxEE-3way3208.js"))).InformationBoxEE
  );
  useOnce(() => {
...
const ListViewPage = ({
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require("./constants-k8_6qCzQ.js"))).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } = await Promise.resolve().then(() => require("./ReviewWorkflowsColumn-BPYhBK7I.js"));
  ...
  const reviewWorkflowFilter = useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require("./constants-k8_6qCzQ.js"))).REVIEW_WORKFLOW_FILTERS,
    {
...
//# sourceMappingURL=index-krtELC3c.js.map
