...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-EOp1yyBx.mjs";
...
import { u as useWebhooks } from "./useWebhooks-CXrSmZRc.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-8dzkZzHo.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-7yZYeLKi.mjs.map
