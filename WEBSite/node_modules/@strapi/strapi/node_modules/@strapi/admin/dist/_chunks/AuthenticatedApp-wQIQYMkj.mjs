...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-EOp1yyBx.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/permissions": "4.25.15",
  "@strapi/provider-audit-logs-local": "4.25.15",
  "@strapi/types": "4.25.15",
  "@strapi/typescript-utils": "4.25.15",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.25.15",
  "@strapi/data-transfer": "4.25.15",
  "@strapi/pack-up": "4.23.0",
  "@strapi/plugin-content-manager": "4.25.15",
...
const CM = React.lazy(
  () => import("./index-EOp1yyBx.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage--G2LJE9t.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-DEbkpBAY.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-0YWvFRqe.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-EOp1yyBx.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-dr0eyiS8.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-pa_Ar4lk.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-wQIQYMkj.mjs.map
