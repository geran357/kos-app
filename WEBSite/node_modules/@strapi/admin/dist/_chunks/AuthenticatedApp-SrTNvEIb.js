...
const CM = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-krtELC3c.js")).then((n) => n.App).then((mod) => ({ default: mod.App }))
);
const HomePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./HomePage-IL82Biip.js")).then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./InstalledPluginsPage-tVR7NBgG.js")).then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./MarketplacePage-03jfxLhv.js")).then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-krtELC3c.js")).then((n) => n.NotFoundPage).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./ProfilePage-n-vDJT6x.js")).then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./SettingsPage-gVT2yhxz.js")).then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-SrTNvEIb.js.map
