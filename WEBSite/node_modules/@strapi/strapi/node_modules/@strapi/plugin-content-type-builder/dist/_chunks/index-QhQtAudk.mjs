...
const ListView$1 = lazy(() => import("./ListView-WGloB_Hx.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-WGloB_Hx.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-QhQtAudk.mjs.map
