...
import "./css/penghuniPembayaran6.css"; // Pastikan menggunakan file CSS yang sesuai

const PenghuniPembayaran6: React.FC = () => {
  const [paymentDetails, setPaymentDetails] = useState<any>(null);
  const navigate = useNavigate(); // Inisialisasi useNavigate
  const paymentId = "jfa18wfp0ialldh9gnp277cl"; // ID yang ingin diambil
...
export default PenghuniPembayaran6;
