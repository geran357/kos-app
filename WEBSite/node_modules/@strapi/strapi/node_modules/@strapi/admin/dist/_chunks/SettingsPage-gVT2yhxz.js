...
const AuthenticatedApp = require("./AuthenticatedApp-SrTNvEIb.js");
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = index.useEnterprise(
    ceLinks,
    async () => (await Promise.resolve().then(() => require("./constants-WeTXow7d.js"))).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-ww1fD1lX.js"));
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require("./CreatePage-w6iStAP9.js"));
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-3LGc1nvj.js"));
  ...
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage--24zj05a.js"));
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-AeKNLG4-.js"));
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require("./CreatePage-GE6QWIOF.js"));
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-m79-NRwG.js")).then((n) => n.EditPage$1);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-zqGccMN8.js"));
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() => require("./ListView-zlEU6jRS.js"));
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require("./CreateView-P86dYiaq.js"));
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() => require("./EditViewPage-x0tA4m9b.js"));
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require("./CreateView-ndBP8Bg0.js"));
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() => require("./ListView-WjqH1ViH.js"));
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() => require("./EditView-Qi7IbrgJ.js"));
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = index.useEnterprise(
    AdminSeatInfoCE,
    async () => (await Promise.resolve().then(() => require("./AdminSeatInfo-v5in2wu5.js"))).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = index.useEnterprise(
    ROUTES_CE,
    async () => (await Promise.resolve().then(() => require("./constants-WENBa6_Z.js"))).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-gVT2yhxz.js.map
