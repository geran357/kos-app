...
const ChecklistTasks5: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        // Memfilter berdasarkan documentId 'sx7plptjvqkugobxgta5f9fr'
        const response = await fetch(
          "http://localhost:1337/api/tasks?filters[documentId][$eq]=sx7plptjvqkugobxgta5f9fr&populate=*"
        );
...
export default ChecklistTasks5;
