...
const ChecklistTasks6: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        // Memfilter berdasarkan documentId 'ni11m1pvgo43xl7wpo6ozqdc'
        const response = await fetch(
          "http://localhost:1337/api/tasks?filters[documentId][$eq]=ni11m1pvgo43xl7wpo6ozqdc&populate=*"
        );
...
export default ChecklistTasks6;
