...
import "./css/penghuniPembayaran4.css"; // Pastikan menggunakan file CSS yang sesuai

const PenghuniPembayaran4: React.FC = () => {
  const [paymentDetails, setPaymentDetails] = useState<any>(null);
  const navigate = useNavigate(); // Inisialisasi useNavigate
  const paymentId = "gkbr8mk66omrpekk0hpvqq7d"; // ID yang ingin diambil
...
export default PenghuniPembayaran4;
